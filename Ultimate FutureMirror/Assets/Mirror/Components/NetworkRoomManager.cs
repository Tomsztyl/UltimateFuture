...
namespace Mirror
{
    ...
    public class NetworkRoomManager : NetworkManager
    {
        ...
        public GameObject roomPlayerInstantiate;
        ...
        public bool isStartedScene=false;
        ...
        //This is select Index Spawn Player
        ...
        public override void OnServerReady(NetworkConnection conn)
        {
            ...
            {
                roomPlayerInstantiate = conn.identity.gameObject;

                // if null or not a room player, dont replace it
                if (roomPlayerInstantiate != null && roomPlayerInstantiate.GetComponent<NetworkRoomPlayer>() != null)
                    SceneLoadedForPlayer(conn, roomPlayerInstantiate);
            }
        }
        ...
        void SceneLoadedForPlayer(NetworkConnection conn, GameObject roomPlayer)
        {
            ...
            if (gamePlayer == null)
            {
                ...
                gamePlayer = startPos != null
                    ? Instantiate(roomSlots[indexSpawnPlayer].choosePlayerRoom, startPos.position, startPos.rotation)
                    : Instantiate(roomSlots[indexSpawnPlayer].choosePlayerRoom, Vector3.zero, Quaternion.identity);
                indexSpawnPlayer++;
            }
        ...
        public override void OnServerAddPlayer(NetworkConnection conn)
        {
            ...
            if (IsSceneActive(RoomScene))
            {
                ...
                //Debug.Log(newRoomGameObject.GetComponent<NetworkIdentity>().netId);
            }
            else
